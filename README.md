...
<table border="0">
  <tr>
    <td width="55%" style="vertical-align: top; border: none;">
      <p>
        🌍 <b>Exploring:</b> Next.js and TypeScript for scalable web apps  <br><br>
        🧠 <b>Building:</b> A modern e-commerce platform using Next.js  <br><br>
        🔍 <b>Contributing:</b> To open-source MERN stack applications [cite: 5]
      </p>
    </td>
    <td width="45%" style="vertical-align: top; border: none;">
      <img src="https://cdn.dribbble.com/users/1708816/screenshots/15637256/media/f9826f0af8a49462f048262a8502035b.gif" width="100%" style="border-radius: 10px;" />
    </td>
  </tr>
</table>
...
<a href="https://github.com/sazzad731">
